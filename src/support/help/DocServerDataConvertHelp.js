...
class ApiDetailExtract {
    ...
    if (typeof parameters !== "undefined") {
      for (let singleParam of parameters) {
        if ("header" === singleParam.in) {
          ...
          if (
            typeof singleParam.type !== "undefined" &&
            singleParam.type === "file"
          ) {
            fileParams.push(this.extractSingleSimpleParam(singleParam));
          } else if (
            typeof singleParam.items !== "undefined" &&
            typeof singleParam.items.type !== "undefined" &&
            singleParam.items.type === "file"
          ) {
            const itme = {
              key: ++this.globalKey,
              default: "",
        ...
        if ("body" === singleParam.in) {
          ...
          if (
            singleParam.schema &&
            typeof singleParam["schema"]["$ref"] !== "undefined"
          ) {
            const realParamTypeName = this.extractRealParamTypeName(
              singleParam["schema"]["$ref"]
            );
            const realRaramTypeDefine = definitions[realParamTypeName];
            if (typeof realRaramTypeDefine !== "undefined") {
              const paramArr = this.extractSingleComplexParam(
                realRaramTypeDefine,
                definitions,
                0
              );
        ...
        } else if ("formData" === singleParam.in) {
          if ("file" === singleParam.type) {
            fileParams.push(this.extractSingleSimpleParam(singleParam));
          } else if (
            typeof singleParam.items !== "undefined" &&
            typeof singleParam.items.type !== "undefined" &&
  ...
  extractSingleSimpleParam(singleParamDefine) {
    ...
    if (
      typeof singleParamDefine.format === "undefined" ||
      null === singleParamDefine.format
    ) {
      paramDefine = {
        key: ++this.globalKey,
        default: defaultVal,
  ...
  extractSingleComplexParam(complexTypeDefine, definitions, callSize) {
    ...
    if (
      typeof complexTypeDefine.properties !== "undefined" &&
      null !== complexTypeDefine.properties
    ) {
      for (const paramName in complexTypeDefine.properties) {
        if (
          typeof complexTypeDefine.properties[paramName].type === "undefined" &&
          typeof complexTypeDefine.properties[paramName]["$ref"] !== "undefined"
        ) {
          const required =
            complexTypeDefine.properties[paramName].allowEmptyValue;
          const realTypeName = this.extractRealParamTypeName(
            complexTypeDefine.properties[paramName]["$ref"]
          );
          if (typeof definitions[realTypeName] !== "undefined") {
            const treeNode = {
              ...
              required: required,
              children: this.extractSingleComplexParam(
                definitions[realTypeName],
                definitions,
                ++callSize
              )
            };
            ...
            const description =
              complexTypeDefine.properties[paramName].description;
            const type = complexTypeDefine.properties[paramName].type;
            const treeNode = this.buildLeafTreeNode(
              paramName,
              description,
              type,
              required
          ...
          const required = Util.arrayContainsVal(
            complexTypeDefine.required,
            paramName
          );
          ...
          if (typeof definitions[realTypeName] !== "undefined") {
            ...
            typeof complexTypeDefine.properties[paramName]
              .additionalProperties !== "undefined" &&
            typeof complexTypeDefine.properties[paramName].additionalProperties[
              "$ref"
            ] !== "undefined"
          ) {
            let additionalProperties =
              complexTypeDefine.properties[paramName].additionalProperties;
            realTypeName = this.extractRealParamTypeName(
          ...
          complexTypeDefine.properties[paramName].type === "array" &&
          typeof complexTypeDefine.properties[paramName].items !==
            "undefined" &&
          typeof complexTypeDefine.properties[paramName].items["$ref"] !==
            "undefined"
        ) {
          const required =
            complexTypeDefine.properties[paramName].allowEmptyValue;
          const realTypeName = this.extractRealParamTypeName(
            complexTypeDefine.properties[paramName].items["$ref"]
          );
          if (typeof definitions[realTypeName] !== "undefined") {
            const treeNode = {
              key: ++this.globalKey,
          ...
          const originalDataTypeDefine =
            complexTypeDefine.properties[paramName];
      ...
      if ("undefined" !== typeof responses[respCode].schema) {
        ...
        if (responses[respCode]["headers"]) {
          ...
          for (const singleHeader in responses[respCode]["headers"]) {
            ...
            const tmp = this.extractSingleSimpleParam(
              responses[respCode]["headers"][singleHeader]
            );
            if (tmp) {
              if (!tmp["name"]) {
        ...
        if (typeof responses[respCode].schema.$ref === "undefined") {
          ...
          realTypeName = this.extractRealParamTypeName(
            responses[respCode].schema.$ref
          );
          responseArr.push({
            key: ++this.globalKey,
            code: respCode,
            description: responses[respCode].description,
            responseStructArr: this.extractSingleComplexParam(
              definitions[realTypeName],
              definitions,
              0
            ),
    ...
    if (paths) {
      ...
      for (const path in paths) {
        ...
        for (const method in paths[path]) {
          if (method == "post") {
            console.log(paths[path][method].parameters);
          }
          const reqParams = extract.extractParam(
            paths[path][method].parameters,
            definitions
          );

          const responseArr = extract.extractReponse(
          ...
          if (
            typeof paths[path][method].tags !== "undefined" &&
            null !== paths[path][method].tags &&
            paths[path][method].tags.length > 0
          ) {
